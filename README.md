...
Supports n × n matrices (2 ≤ n ≤ 5)

Computes LDU decomposition such that
                                 A=L×D×U
...
Verification module reconstructs the original matrix using L×D×U
...
JavaScript – Matrix operations and logic
